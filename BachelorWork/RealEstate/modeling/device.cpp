...
void device::SetNextTime(double NewNextTime){NextTime=CurrentTime+NewNextTime;}
...
{
	ChangeOutputOnScreenString(LineNumber,ColumnNumber,AddSpacesToString(state,7)+"|");
}