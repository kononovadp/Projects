...
{
	int CountOfTasks,CountOfCreatedTasks,TotalCountOfTasks,CountOfDelays,BarSize,BarPos;
	double percent,BarProgress,BarStep,ActiveTime;
	double AverageDelay,AverageTimeForOneTask,AverageTaskComplexity;
