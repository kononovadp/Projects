...
void siftDown(int *numbers, int root, int bottom)
{
	...
	int temp,done = 0; // флаг того, что куча сформирована
...
int main(void)
{
	...
	fprintf(TestFile,"%60s%22s%22s%22s%22s%22s\n","Quick sort (opt.)","Counting sort","Merge sort (rec.)","Merge sort (iter.)","Smooth sort","Heap sort");
