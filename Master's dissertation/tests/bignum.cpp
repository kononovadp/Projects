...
{	
	...
	int ResultSize=MaxBignumLength+Bignum1Length+Bignum2Length;
	char* bignum1=(char*)malloc(ResultSize*sizeof(char));
	char* bignum2=(char*)malloc(ResultSize*sizeof(char));
