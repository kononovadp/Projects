...
{    if pos(comma,s)>0 then begin
    n:=pos(comma,s); delete(s,n,1); insert('.',s,n); end;  }
...
bracket1.enabled:=false; bracket2.enabled:=false;
{system1.enabled:=false; system2.enabled:=false;
Convop1.enabled:=false;} end
else begin
bracket1.enabled:=true; bracket2.enabled:=true;
{system1.enabled:=true; system2.enabled:=true;
Convop1.enabled:=true;} end; end;
