...
begin
//write('object name:  '); readln(n); write('object size:  '); readln(s);
name:=n; size:=s;
SetLength(v,size);
end;
...
begin
write('object name:  '); readln(n); write('object size:  '); readln(s);
a.init(n,s);//конструктор
a.input; a.output;
a.sort;  writeln('sorted array:'); a.output;
a.DeleteObject;//деструктор
writeln('Object deleted. Trying output of the deleted object'); a.output;
readln;
end.
