...
var jbl{адрес метки (для jb)},m{//$}:integer;
    ...
    cc{код команды},pr,pr2{префиксы},od{смещение переменной}:string;
...
var g,temp,il,main,dataseg:text;
...
if jbprov=true then writeln('Code segment successfully analized!');
end;
begin
FirstPass;
datasegment;
