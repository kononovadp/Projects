...
var s,s1,c,l,reg,ds,ad,cs,cd:string; i,j,n:byte; s5: set of char;
f,a_res,temp1,temp2,temp3,temp4,f3:text; ch,ch2:char; b1:boolean;
...
writeln(a_res,c,'|',ds,'|',ad,'|',cs,'|',cd,'|');
writeln(c,'|',ds,'|',ad,'|',cs,'|',cd,'|'); goto label2; end;
...
label1:
writeln(a_res,l,c,'|',reg,'/',s,'\');     writeln(l,c,'|',reg,'/',s,'\');
